...
export function buildValues(fields: ReadonlyArray<Field>, source?: Record<string, unknown> | null): FormValues {
    const values: FormValues = {};
    for (const field of fields) {
        values[field.name] =
            field.type === "switch" ? Boolean(source?.[field.name] ?? false) : toFormValue(source?.[field.name]);
    }
    return values;
}
