...
export function Panel({ className, ticked = false, ...props }: ComponentProps<"section"> & { ticked?: boolean }) {
    return (
        <section className={cn("panel", ticked && "ticked", "animate-in fade-in duration-200", className)} {...props} />
    );
}
...
export function Eyebrow({ as: As = "p", className, ...props }: ComponentProps<"p"> & { as?: ElementType }) {
