...
function EventsPage() {
    ...
    const totals = useMemo(() => {
        ...
        const spent = rows.reduce((acc, event) => acc + eventFinance(event, txns, budgetItems).actualExpense, 0);
    ...
    return (
        <>
            ...
            <StatGrid className="xl:grid-cols-3">
                ...
                <StatCell label="Planned budget" value={formatMoney(totals.planned)} caption="Across events" />
                <StatCell label="Actual spend" value={formatMoney(totals.spent)} caption="Linked transactions" />
            </StatGrid>
