...
export const Route = createFileRoute("/_authenticated/calendar")({
    head: () => ({
        meta: [
            ...
            {
                name: "description",
                content: "Month, week, day and agenda views of scheduled items, task due dates and event milestones.",
            },
...
function CalendarPage() {
    ...
    return (
        <>
            ...
            <div className={cn("grid gap-6 xl:grid-cols-[minmax(0,1fr)_20rem]", printOptions && "print:hidden")}>
                <Panel>
                    <PanelHeader
                        eyebrow={view}
                        title={heading}
